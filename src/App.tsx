...
import { Budget, Goal, RecurringTransaction, Obligation, Debt, BNPLPlan, DataPayload } from './types';
...
export default function App(){
  ...
  function handleExport(kind: 'json'|'csv'|'pdf') {
    const payload: DataPayload = { budgets, recurring, goals, debts, bnplPlans };
  ...
  function handleImport(payload: DataPayload) {
    try {
